...
Это полезно не только для самих программистов, но и для инструментов статической проверки кода, таких как mypy,
а также для улучшения читаемости и поддержки кода.

Аннотация типов позволяет указать тип данных, который должен храниться в переменной или быть возвращён функцией.
...
вы можете почитать дополнительные материалы, например в [этой статье](https://habr.com/ru/companies/lamoda/articles/432656/).
